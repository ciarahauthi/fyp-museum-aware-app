  ...
  return (
    <section className="upload-page">
      <header className="upload-header">
        <button className="upload-back-btn" onClick={() => navigate("/manage-content")}>← Back</button>
        <h1 className="upload-title">Upload {folder} image</h1>
      </header>

      <section className="upload-body">
        <section className="upload-dropzone" onClick={() => fileInputRef.current?.click()}>
          <p>Click to select an image</p>
          <button className="upload-choose-btn" type="button">Choose file</button>
          <input
            ref={fileInputRef}
            type="file"
